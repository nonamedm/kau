		...
		<article id="sub_contents" class="cont s_body" style="text-align:center;">
			<div class="location margin-top-60 col-lg-12 col-md-12 col-sm-12" style="display:flex;">
				...
				<div style="width:100%; text-align: left; padding-left:5%;">
					...
					<span class="material-icons" style="position:absolute">call</span><p style="font-size: 15px;margin-bottom: 10px;color: #525252;margin: -1px 0 0 30px;"> <a href="tel:02-300-0235">02-300-0235</a></p><br>
					...
					<p style="font-size: 15px;margin-bottom: 10px;color: #525252;margin: -1px 0 0 30px;"> <a href="https://www.facebook.com/kau.accompany">한국항공대학교 총학생회 (kau.accompany)</a></p><br>
					...
					</svg><p style="font-size: 15px;margin-bottom: 10px;color: #525252;margin: -1px 0 0 30px;"> <a href="https://www.instagram.com/kau._.hr/">한국항공대학교 총학생회 (@kau._.hr)</a></p><br>
					<span class="material-icons" style="position:absolute">mail</span><p style="font-size: 15px;margin-bottom: 10px;color: #525252;margin: -1px 0 0 30px;"> <a href="mailto:kaustudentcouncil@gmail.com">kaustudentcouncil@gmail.com</a></p><br>
